...
class Fm_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_center_freq(98300000, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_wfm_rcv_0, 0), (self.qtgui_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 256000, 25600, window.WIN_HAMMING, 6.76))
        self.qtgui_sink_x_0.set_frequency_range(10190000, self.samp_rate)
